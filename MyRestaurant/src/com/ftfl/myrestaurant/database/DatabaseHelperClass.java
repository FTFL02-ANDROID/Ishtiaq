package com.ftfl.myrestaurant.database;
...
public class DatabaseHelperClass extends SQLiteOpenHelper {
	...
	public static final String RESTAURANT_COLUMN_IMAGE_PATH = "imagepath";
	...
	public void onCreate(SQLiteDatabase db) {
		...
		db.execSQL("CREATE TABLE restaurant"
				+ "(id INTEGER PRIMARY KEY,  name TEXT,address TEXT,latitude TEXT,longitude TEXT,menus TEXT,special_menu TEXT,close_day TEXT,daily_open_time TEXT,description TEXT,imagepath TEXT)");
